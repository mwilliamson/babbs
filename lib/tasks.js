...
Task.prototype._doAction = function() {
    return this._action.run(this.workspace, this.config.action);
};
...
function fetchDependency(task, dependency) {
    // TODO: bind action variables (workspace, args) on task construction
    return dependency._action.exportToDependent(
        dependency.workspace,
        dependency.config.action,
        task.workspace
    );
}
